...
class Window(QtGui.QWidget):
    ...
    def create(self):
        ...
        maxim = QtGui.QPushButton(maxIco, "", self)
        ...
        #Create app buttons
        #Titlebar
        add = QtGui.QPushButton("Neu", self)
        ...
        m100 = QtGui.QPushButton("M100", self)
        ...
        m104 = QtGui.QPushButton("M104", self)
        ...
        m114 = QtGui.QPushButton("M114", self)
        ...
        m117 = QtGui.QPushButton("M117", self)
        ...
        m123 = QtGui.QPushButton("M123", self)
        ...
        m403 = QtGui.QPushButton("M403", self)
        ...
        m404 = QtGui.QPushButton("M404", self)
        ...
        m431 = QtGui.QPushButton("M431", self)
        ...
        #Main Part
        #Create
        mLabel = QtGui.QLabel("Modul Wählen:")
        mLabel.setObjectName("moduleLabel")
        mLabel.setMaximumWidth(130)

        self.module = QtGui.QComboBox()
        self.module.addItems(["100", "104", "114", "117", "123", "403", "404", "431"])
        self.module.setObjectName("comboBox")
        self.module.setMaximumWidth(150)

        self.lQuestion = QtGui.QLabel("Frage:")
        self.lQuestion.setObjectName("moduleLabel")
        self.lQuestion.setMaximumSize(QtCore.QSize(130, 50))

        self.eQuestion = QtGui.QTextEdit("")
        self.eQuestion.setMaximumSize(QtCore.QSize(400, 50))
        self.eQuestion.setObjectName("textEdit")

        self.ac1 = QtGui.QCheckBox()
        self.ac1.setMaximumWidth(130)
        self.ac2 = QtGui.QCheckBox()
        self.ac2.setMaximumWidth(130)
        self.ac3 = QtGui.QCheckBox()
        self.ac3.setMaximumWidth(130)
        self.ac4 = QtGui.QCheckBox()
        self.ac4.setMaximumWidth(130)

        self.ae1 = QtGui.QTextEdit()
        self.ae1.setMaximumSize(QtCore.QSize(400, 50))
        self.ae2 = QtGui.QTextEdit()
        self.ae2.setMaximumSize(QtCore.QSize(400, 50))
        self.ae3 = QtGui.QTextEdit()
        self.ae3.setMaximumSize(QtCore.QSize(400, 50))
        self.ae4 = QtGui.QTextEdit()
        self.ae4.setMaximumSize(QtCore.QSize(400, 50))

        endBtn = QtGui.QPushButton("Hinzufügen")
        endBtn.clicked.connect(self.addNQuestion)

        #Learn
        self.lQuest = QtGui.QLabel("Frage")
        self.lQuest.setObjectName("moduleLabel")
        self.lQuest.setMaximumSize(QtCore.QSize(130, 50))

        self.acl1 = QtGui.QCheckBox()
        self.acl1.setMaximumWidth(130)
        self.acl2 = QtGui.QCheckBox()
        self.acl2.setMaximumWidth(130)
        self.acl3 = QtGui.QCheckBox()
        self.acl3.setMaximumWidth(130)
        self.acl4 = QtGui.QCheckBox()
        self.acl4.setMaximumWidth(130)

        self.atl1 = QtGui.QLabel("1")
        self.atl1.setMaximumSize(QtCore.QSize(400, 50))
        self.atl2 = QtGui.QLabel("2")
        self.atl2.setMaximumSize(QtCore.QSize(400, 50))
        self.atl3 = QtGui.QLabel("3")
        self.atl3.setMaximumSize(QtCore.QSize(400, 50))
        self.atl4 = QtGui.QLabel("4")
        self.atl4.setMaximumSize(QtCore.QSize(400, 50))

        nextBtn = QtGui.QPushButton(nextIco, "")
        nextBtn.clicked.connect(self.checkAnswers)
        nextBtn.setMaximumSize(QtCore.QSize(200, 30))

        self.correction = QtGui.QLabel("")
        ...
        #Widgets
        self.wCent = QtGui.QWidget(self)
        self.wCreate = QtGui.QWidget(self)
        self.wModule = QtGui.QWidget(self)
        ...
        vCenter = QtGui.QVBoxLayout()
        self.sStack = QtGui.QStackedLayout(self)
        hCModule = QtGui.QHBoxLayout()
        hQuestion = QtGui.QHBoxLayout()
        gAnswers = QtGui.QGridLayout()
        hEnd = QtGui.QHBoxLayout()

        #Learing Layouts
        vLCenter = QtGui.QVBoxLayout()
        gLAnswers = QtGui.QGridLayout()
        hPN = QtGui.QHBoxLayout()
        vCorrect = QtGui.QVBoxLayout()
        ...
        hQuestion.setAlignment(QtCore.Qt.AlignTop)
        gAnswers.setAlignment(QtCore.Qt.AlignTop)
        ...
        hQuestion.setContentsMargins(100,20,100,10)
        ...
        hCModule.addItem(QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum))
